...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center bg-[#25D366] text-white shadow-[0_10px_30px_-10px_rgba(0,0,0,0.45)] transition-transform duration-300 hover:scale-105 motion-reduce:transition-none motion-reduce:hover:scale-100 md:bottom-7 md:right-7"
    >
